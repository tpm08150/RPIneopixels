...
#         self.loadFileButton.bind(on_press=self.loadFile)
        ...
        self.RGBPixelsButton = Button(text='RGB', background_color='gray', size_hint_x=0.1, size_hint_y=0.1)
        self.pixelGrid.add_widget(self.RGBPixelsButton)
        self.RGBPixelsButton.bind(on_press=self.RGBPixels)
        
        self.GRBPixelsButton = Button(text='GRB', background_color='gray', size_hint_x=0.1, size_hint_y=0.1)
        self.pixelGrid.add_widget(self.GRBPixelsButton)
        self.GRBPixelsButton.bind(on_press=self.GRBPixels)
        
        self.BGRPixelsButton = Button(text='BGR', background_color='gray', size_hint_x=0.1, size_hint_y=0.1)
...
#         print("test")
    ...
    def slide_it_brightness(self, *args):
        global master
        master = args[1]/10
        self.RGBbrightness.text = str(round(float(args[1]) * 100, 1))
    
    def slide_it_speed(self, *args):
        global speed
        speed = 1/args[1]
        self.RGBspeed.text = str(round(float(args[1]) * 5, 1))
