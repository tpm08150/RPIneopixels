...
class MyLayout(GridLayout):
    def __init__(self, **kwargs):
        ...
        self.clearGroupButton = Button(text='Clear Group', background_color='gray', size_hint=(.3, .25), pos=(0, 1))
        self.groupControlGrid.add_widget(self.clearGroupButton)
        self.clearGroupButton.bind(on_press=self.clearGroup)
        ...
        self.group1Button = Button(text='Group 1', background_color='gray', size_hint=(.3, .25), pos=(0, 1))
        self.group2Button = Button(text='Group 2', background_color='gray', size_hint=(.3, .25), pos=(0, 1))
        self.group3Button = Button(text='Group 3', background_color='gray', size_hint=(.3, .25), pos=(0, 1))
        self.group4Button = Button(text='Group 4', background_color='gray', size_hint=(.3, .25), pos=(0, 1))
        self.group5Button = Button(text='Group 5', background_color='gray', size_hint=(.3, .25), pos=(0, 1))
        self.group6Button = Button(text='Group 6', background_color='gray', size_hint=(.3, .25), pos=(0, 1))
        self.group7Button = Button(text='Group 7', background_color='gray', size_hint=(.3, .25), pos=(0, 1))
        self.group8Button = Button(text='Group 8', background_color='gray', size_hint=(.3, .25), pos=(0, 1))
        self.group9Button = Button(text='Group 9', background_color='gray', size_hint=(.3, .25), pos=(0, 1))
        self.group10Button = Button(text='Group 10', background_color='gray', size_hint=(.3, .25), pos=(0, 1))
        self.group11Button = Button(text='Group 11', background_color='gray', size_hint=(.3, .25), pos=(0, 1))
        self.group12Button = Button(text='Group 12', background_color='gray', size_hint=(.3, .25), pos=(0, 1))
        self.group13Button = Button(text='Group 13', background_color='gray', size_hint=(.3, .25), pos=(0, 1))
        self.group14Button = Button(text='Group 14', background_color='gray', size_hint=(.3, .25), pos=(0, 1))
        self.group15Button = Button(text='Group 15', background_color='gray', size_hint=(.3, .25), pos=(0, 1))
        self.group16Button = Button(text='Group 16', background_color='gray', size_hint=(.3, .25), pos=(0, 1))
